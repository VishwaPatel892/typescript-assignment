...
** GitHub Repository:** [VishwaPatel892/typescript-assignment](https://github.com/VishwaPatel892/typescript-assignment)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VishwaPatel892/typescript-assignment.git
   cd food-order
   ```
